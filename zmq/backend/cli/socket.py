...
#from ZeroMQ.lib.zmq import (new_uint64_pointer, new_int64_pointer,
...
class Socket(object):
    ...
    def __init__(self, context=None, socket_type=None, shadow=None):
        ...
        if shadow is not None:
            ...
            self._shadow = False
            self._zmq_socket = ZSocket(context._zmq_ctx, socket_type)
        self._closed = False
        if context:
    ...
    @property
    def linger(self):
        return self._zmq_socket.Linger.TotalMilliseconds
